...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header('Location: kasirPesanan.php?success=1');
    exit();
}
...
<head>
    ...
    <link rel="stylesheet" href="../skripsi/css/styleKasirTambahPesananOffline.css">
...
<body>
    <div class="container mt-5">
        ...
        <form method="POST" action="">
            ...
            <a id="def" href="kasirPesanan.php" class="btn btn-secondary">Kembali</a>
        </form>
    </div>
    <script>
