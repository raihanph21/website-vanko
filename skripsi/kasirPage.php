...
<head>
    ...
    <!-- link css -->
    <link rel="stylesheet" type="text/css" href="../skripsi/css/styleKasir.css">
...
<body>
    <div class="row">
        <div class="col-3" id="sticky-sidebar">
            <div class="sticky-top">
                <div class="nav flex-column">
                    ...
                    <li href="#_" class="nav-link text-center active"><a href="kasirPage.php">Stok</a></li>
                    <li href="#_" class="nav-link text-center"><a href="kasirPesanan.php">Pesanan</a></li>
        ...
        <div class="col-9">
            ...
            <table id="myTable" class="table table-bordered table-striped table-hover text-center mt-3">
